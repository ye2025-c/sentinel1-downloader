...
面向遥感科研的桌面数据获取工具，支持 **Sentinel-1（SAR）** 与 **Sentinel-2（光学）** 影像的可视化搜索与批量下载。数据源为 [Copernicus Data Space Ecosystem (ESA)](https://dataspace.copernicus.eu)。
...
│   ├── downloader.py       # download() 下载内核（数据源无关）
